    ...
    return (
        <>
            ...
            <Modal showModal={ showPreviewModal } setShowModal={ setShowPreviewModal }>
                <div
                    className='inline-block w-full my-12  space-y-6 max-w-[1200px] p-2 md:py-8 md:px-5  overflow-hidden text-center align-middle transition-all bg-white dark:bg-gray-900 shadow-xl rounded-lg'>
